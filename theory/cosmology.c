...
void set_tomo_BCC()
{
  ...
  tomo.shear_Nbin        = 3;
  tomo.shear_zmax[0]      = 0.34;
  tomo.shear_zmax[1]      = 0.9;
  tomo.shear_zmax[2]      = 1.99;
  tomo.shear_zmax[3]      = 0.0;
  tomo.shear_zmax[4]      = 0.0;
  
  tomo.shear_zmin[0]      = 0.01;
  tomo.shear_zmin[1]      = 0.34;
  tomo.shear_zmin[2]      = 0.9;
  tomo.shear_zmin[3]      = 0.0;
  tomo.shear_zmin[4]      = 0.0;
}
...
printf("set_tomo_DES_conti\n");
  tomo.shear_Nbin        = 5;
  tomo.shear_zmax[0]      = 1.06;
  tomo.shear_zmax[1]      = 1.49;
  tomo.shear_zmax[2]      = 1.83;
  tomo.shear_zmax[3]      = 2.13;
  tomo.shear_zmax[4]      = 3.0;
  
  tomo.shear_zmin[0]      = 0.0;
  tomo.shear_zmin[1]      = 1.06;
  tomo.shear_zmin[2]      = 1.49;
  tomo.shear_zmin[3]      = 1.83;
  tomo.shear_zmin[4]      = 2.13;
}
